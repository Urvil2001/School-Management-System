<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="ReplyLeaveApplicationOfTeacher.aspx.cs" Inherits="Admin_ReplyLeaveApplicationOfTeacher" %>
...
<center>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="standardid" HeaderText="Standard" />
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
        ...
        SelectCommand="SELECT [leaveapplicationid], [description], CONVERT(varchar(10),[leavedate],110) as leavedate, [noofdays], [studentname], [standardid], [rollno] FROM [Leave_application] WHERE ((rollid='3') AND (status='Pending'))">
