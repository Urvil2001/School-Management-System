<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Teacherleaveapplication.aspx.cs" Inherits="Admin_Teacherleaveapplication" %>
           ...
           <div class="card">
                        <div class="card-header">
                            <h3><center><strong class="card-title">
                                <lable>Reply Teacher LeaveApplication</lable></strong></center>
...
<center>
    ...
    <br />
    <asp:Button ID="Button1" runat="server" Text="Accept Leave Application"  CssClass="btn btn-lg btn-info btn-block" />
