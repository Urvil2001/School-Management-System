<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Complaint_Reply.aspx.cs" Inherits="Admin_Complaint_Reply" %>
           ...
           <div class="card">
                        <div class="card-header">
                            <h3><center><strong class="card-title">
                                <lable>Student Complaint Reply</strong></center>
                                  ...
                                  <form id="fo1" runat="server">
                                      ...
                                      <tr>
                                        ...
                                        <td align="center" style="width:350px">
                                         ...
                                         <tr>
                                        <td align="center" style="width:350px">
                                         <strong> <label for="cc-payment" class="control-label mb-1">Complaint</label></strong>
                                         ...
                                         <tr>
                                        <td align="center" style="width:350px">
                                         <strong> <label for="cc-payment" class="control-label mb-1">Complaint Reply</label></strong>
